...
const OutcomeDataTab = ({ isActive, onClick }) => (
...
export const OutcomeDataContent  = () => {
    
  const tableData = [
    {
      mainHeader: { label: 'Outcome Data', className: 'bg-primary text-white' },
      subheadings: [
      ...
      rows: [
        { category: 'Outreach', data: [ 80000, 60000, 25000, 5000, 120000, 90000, 40000, 8000, 150000, 120000, 80000, 15000, 15000, 15000] },
        { category: 'Shelter', data: [ 12000, 9000, 4000, 1000, 15000, 10000, 5000, 1500, 18000, 15000, 6000, 2000, 15000, 15000] },
        { category: 'Navigation/Placement', data: [10000, 5000, 2000, 500, 15000, 10000, 5000, 1500, 18000, 15000, 6000, 2000, 15000, 15000] },
        { category: 'RRH', data: [10000, 5000, 2000, 500, 12000, 10000, 5000, 1500, 18000, 15000, 6000, 2000, 15000, 15000] },
        { category: 'Supportive Housing Case Management', data: [10000,  9000, 4000, 1000, 15000, 10000, 5000, 1500, 18000, 15000, 6000, 2000, 15000, 15000] },
        { category: 'Eviction Prevention', data: [10000, 5000, 2000, 500, 15000, 10000, 5000, 1500, 18000, 15000, 6000, 2000, 15000, 15000] }
      ]
    }
  ];
